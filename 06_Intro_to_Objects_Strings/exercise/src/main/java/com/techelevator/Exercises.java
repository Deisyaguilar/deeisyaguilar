...
public class Exercises {
	...
	public String left2(String str) {
		...
		String allOfTheLetters = str.substring(2);
		return allOfTheLetters + firstTwoLetters;
	}
	...
	public String stringYak(String str) {
		int isYak = str.indexOf("yak");
		while (isYak != -1) {
			str = str.substring(0, isYak) + str.substring(isYak +3);
			isYak = str.indexOf("yak");
		}
		return str;
	}
